    ...
    <main className={classes.main}>
      ...
      <Paper className={classes.paper}>
        ...
        <FormControl margin="normal" required fullWidth data-validators="isLogin" >
          ...
          {
            props.doesLoginExist?<FormHelperText margin="dense" error={true}>Podany Login już istnieje!</FormHelperText>:null
            
          }
          {
            props.doesEmailExist?<FormHelperText margin="dense" error={true}>Podany Email już istnieje!</FormHelperText>:null
          }
          <Button
            type="submit"
            fullWidth
